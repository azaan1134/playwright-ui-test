...
* XPath нь DOM-ийн шаталсан бүтцээс шууд хамаардаг тул UI-ийн жижиг өөрчлөлтөд тест амархан унах эрсдэлтэй байдаг. Мөн бодит хэрэглэгч вэбтэй харилцахдаа HTML-ийн код эсвэл ID хардаггүй, харин товчин дээрх текст, оруулах талбарын Placeholder-ийг хардаг. Иймд Playwright-ийн орчин үеийн getByRole, getByPlaceholder, getByText(..., { exact: true }) locator-уудыг ашигласан. Код дотор waitForTimeout болон гараар хүлээлгэх ямар нэгэн саатуулах код ашиглаагүй. Playwright-ийн Auto-wait механизм болон expect() assertion-уудыг ашигласан. Амжилттай нэвтрэх үйлдэл хийсэн тест бүр төгсгөлдөө Logout үйлдэл хийж, нэвтрэх хуудасны URL шалгасан.
...
### Codegen
npx playwright codegen ашиглахад суурь locator-ууд болон товч дарах үйлдлийн дарааллыг маш хурдан гаргаж өгсөн. Гэвч Codegen нь assertion (expect) болон тестийн шалгалтуудыг автоматаар бүрэн зохион байгуулдаггүй бөгөөд зарим үед хэт тусгайлсан locator сонгодог. Codegen-ээр бичүүлсэн тест файл (docs/codegen.ts). Мөн миний бичсэн тестээс ялгаатай байдлын хувьд нэвтэрсний дараа URL өөрчлөгдсөн эсэх (toHaveURL), элемент харагдаж байгаа эсэхийг (toBeVisible) шалгах логикийг автоматаар гүйцэт бичиж чаддаагүй. Барааг эрэмбэлэх тест дээр "Low to High" товч дарсны дараа хамгийн бага үнэтэй бүтээгдэхүүн ("Sauce Labs Onesie") хамгийн эхэнд гарч ирж байгааг баталгаажуулах шалгалтын кодыг Codegen автоматаар үүсгэж чадаагүй.
